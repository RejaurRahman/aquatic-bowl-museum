          ...
          <div class="columns no-margin no-margin-auto column-reversed">
            <div class="column is-6 main-text suitable-vertically">
              <h1 class="color-green">
                <span>sea life creatures</span>
              </h1>
              <p class="color-black">Which creatures are you fond of seeing? <span>apex sharks</span>, <span>colourful koi carps</span> or perhaps the <span>amazonian piranhas</span>?</p>
              <p class="color-black">Here at SEA LIFE you can make up your mind and see them all - from the curious and the rescued to the rare and the enigmatic. And you’ll be able to get closer to them than ever before.</p>
              <p class="color-black">Most of our animals you will find on the endangered list, rescued by our recovery team or not ready for the wild.</p>
              <div class="columns">
                <div class="column is-half">
                  <button class="blue-button link-icon" @click="discoverZone()">
                    <span>go to discover zone</span>
                  </button>
                </div>
              </div>
...
<style scoped lang="scss">
  .home-container {
    .home-slide-section {
      background-image: url('../../assets/images/home/backgrounds/homepage-slide-3-bg.jpg');
